...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li><button onClick={courseClickHandler}>Courses</button></li>
  ...
  return (
    <div className={`max-w-screen-8xl px-2 py-2 mx-auto fixed top-0 left-0 right-0 z-50 ${sticky ? 'sticky-navbar shadow-md bg-base-200 dark:bg-slate-900 dark:text-white duration-300 transition-all ease-in-out' : ''}`}>
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          <label className="swap swap-rotate">
            <input type="checkbox" onChange={() => setTheme(theme === 'dark' ? 'light' : 'dark')} checked={theme === 'dark'} />
